use crate::common::header::{
    Header, MessageType, QueryType, IS_AUTHORITATIVE_ANSWER_BIT_MASK,
    IS_RECURSION_AVAILABLE_BIT_MASK, IS_RECUSTION_DESIRED_BIT_MASK, IS_TRUNCATED_BIT_MASK,
    MESSAGE_TYPE_BIT_MASK, QUERY_TYPE_INVERSE_BIT_VALUE,
    QUERY_TYPE_SERVER_STATUS_REQUEST_BIT_VALUE, QUERY_TYPE_STANDARD_BIT_VALUE,
};

use super::push_u16_to_u8_vec;
